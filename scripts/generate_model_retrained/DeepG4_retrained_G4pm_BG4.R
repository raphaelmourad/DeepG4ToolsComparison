...
training <- DeepG4(x_train,y_train,retrain=TRUE,retrain.path = "rds/DeepG4_retrained_G4seqpm_BG4_1_1.h5")

test <- DeepG4(x_test,y_test,retrain.path = "rds/DeepG4_retrained_G4seqpm_BG4_1_1.h5")
library(cowplot)
